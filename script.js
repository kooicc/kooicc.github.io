const qsoLogs = [
  ...
  ["", "BH4GDY", "/", "/", "/", "上海", "2026-08-22", ""],
  ["", "BH4GUW", "/", "/", "/", "上海", "2026-08-22", ""],
  ["2026-08-19 09:49", "BG2MGR", "14.074", "FT8", "", "吉林-长春市", "2026-08-22", ""],
  ["2026-08-17 16:40", "BI4AEL", "14.074", "FT8", "-5", "上海", "2026-08-22", ""],
  ["2026-08-17 00:52", "BH6AWZ", "14.074", "FT8", "-3", "安徽-六安市", "2026-08-22", ""],
  ["2026-08-17 00:40", "BI4IXO", "14.074", "FT8", "-15", "山东-威海", "2026-08-22", "2026-09-02"],
  ["2026-08-16 14:29", "BD8FOD", "14.074", "FT8", "-19", "四川-成都", "2026-08-22", ""],
  ["2026-08-16 13:36", "BI4BGJ", "14.074", "FT8", "-18", "上海", "2026-08-22", ""],
  ["2026-08-16 12:48", "BA7SAY", "14.074", "FT8", "-8", "广西-梧州", "2026-08-22", ""],
  ["2026-08-16 12:00", "BH4ECL", "14.074", "FT8", "-4", "上海", "2026-08-22", ""]
]
.sort((a, b) => {
  if (a[0] > b[0]) return -1;
  if (a[0] < b[0]) return 1;
